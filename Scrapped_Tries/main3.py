"""
v3 backup — JM with AR inside features, binary backtest (no gate).

Run:  python main3.py
Snapshots: src/backtest3.py, src/features3.py, output3/

Other backups: v1 main1/output_v1 | v2 main2/output_v2
Current: python main.py (JM-only + asymmetric AR overlay)
"""
